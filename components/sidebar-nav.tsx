...
import { MessageSquare, LayoutDashboard, Headphones, Settings, ChevronRight, Sparkles } from "lucide-react"
import { cn } from "@/lib/utils"
import { useAuth } from "@/components/auth-provider"

const navItems = [
  { title: "AI Support", href: "/", icon: MessageSquare, description: "Chat with AI" },
  { title: "Dashboard", href: "/dashboard", icon: LayoutDashboard, description: "Kanban board" },
  { title: "Staff Panel", href: "/staff", icon: Headphones, description: "Manage tickets" },
